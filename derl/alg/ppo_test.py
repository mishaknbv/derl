...
def test_ppo_atari_interactions(ppo_atari_alg):
    assert_interactions(
        "testdata/ppo/atari/interactions.npz", ppo_atari_alg, rtol=1e-6, atol=1e-6
    )
...
def test_ppo_atari_losses(ppo_atari_alg):
    ...
    assert_losses("testdata/ppo/atari/losses.pt", ppo_atari_alg, rtol=1e-5, atol=1e-5)
...
def test_ppo_mujoco_interactions(ppo_mujoco_alg):
    assert_interactions(
        "testdata/ppo/mujoco/interactions.npz", ppo_mujoco_alg, rtol=0, atol=1e-4
    )


def test_ppo_mujoco_grad(ppo_mujoco_alg):
    assert_grad("testdata/ppo/mujoco/grads.pt", ppo_mujoco_alg, rtol=1e-5, atol=1e-5)
...
def test_ppo_mujoco_losses(ppo_mujoco_alg):
    ...
    assert_losses("testdata/ppo/mujoco/losses.pt", ppo_mujoco_alg, rtol=1e-5, atol=1e-5)
